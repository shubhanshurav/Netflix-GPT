  ...
  return (
    <div className='bg-gray-800'>
        <div className='h-screen object-cover' style={{backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.8), rgba(0, 0, 0, 0.6)), url(${BG_URL})`}}>
            <div className='flex justify-between px-6 md:px-20 py-6 items-center'>
            ...
            <div>
                <div className='text-white text-center mt-14 my-4'>
                    <h1 className='text-3xl md:text-6xl font-bold'>Enjoy big movies, hit series</h1>
                ...
                <div className='text-center my-6'>
                    ...
                    <Link to='/login' >
                       <button className='py-2 md:py-4 px-2 text-lg md:text-2xl text-white bg-red-600 rounded-md w-[50%] md:w-[15%]' type='button'><span>Get Started</span></button>
                    </Link>
                </div>
            </div>
        </div>
        ...
        <div className='flex flex-col md:flex-row flex-wrap px-2 mt-2 gap-1 bg-black h-screen object-cover'>
            <div className='text-white text-center w-[100%] md:w-[53%] m-auto pl-10 text-start'>
                <h1 className='text-3xl md:text-6xl font-bold py-8'>Enjoy on your TV</h1>
                <p className='text-xl md:text-3xl'>Watch on smart TVs, PlayStation, Xbox, Chromecast, Apple TV, Blu-ray players and more.</p>
            </div>
        ...
        <div className='flex flex-col items-center -mt-20 mt-2 md:flex-row flex-wrap px-2 gap-1 bg-black h-screen object-cover w-[100%]'>
            <div className='w-[100%] md:w-[50%] text-center'>
                ...
                <div className='flex -mt-28 relative bg-black border w-[55%] md:w-[45%] m-auto border-gray-400 justify-between px-4 py-2 rounded-2xl'>
            ...
            <div className='w-[100%] md:w-[48%] m-auto text-start'>
                <h1 className='text-3xl md:text-6xl font-bold text-white py-2 px-5 md:px-0'>Download your shows to watch offline</h1>
                <p className='text-lg md:text-2xl text-white py-4 px-5 md:px-0'>Save your favourites easily and always have something to watch.</p>
            </div>
        </div>

        <div className='flex flex-col md:flex-row flex-wrap -mt-20 mt-2 px-2 gap-1 bg-black h-screen object-cover'>
            <div className='text-white text-center w-[100%] md:w-[53%] m-auto px-12 md:pl-20 text-start'>
                <h1 className='text-4xl md:text-6xl font-bold py-2'>Watch</h1>
                <p className='text-4xl md:text-6xl font-bold pb-6'>everywhere</p>
                <p className='text-lg md:text-2xl font-semibold'>Stream unlimited movies and TV shows on your phone, tablet, laptop, and TV.</p>
            </div>
            <div className='text-center w-[100%] md:w-[45%] m-auto'>
                <div className='absolute'>
        ...
        <div className='flex flex-col items-center -mt-20 mt-2 md:flex-row flex-wrap px-2 gap-1 bg-black h-screen object-cover w-[100%]'>
            ...
            <div className='w-[100%] md:w-[48%] m-auto text-start px-8 md:px-0'>
                ...
                <p className='text-lg md:text-2xl text-white py-4'>Send children on adventures with their favourite characters in a space made just for them—free with your membership.</p>
            </div>
        </div>
